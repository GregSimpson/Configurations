...
# my aliases
alias b='cd ..'
alias base_local='export base_url="http://localhost:1880/nodered"'
alias dockerSession='docker exec -it nodered /bin/bash'
...
alias intellij='sudo /snap/intellij-idea-ultimate/current/bin/idea.sh'
